...
const quickActions = [
  { icon: Plus, label: "Add Property", color: "from-primary to-accent" },
  { icon: FileText, label: "Reports", color: "from-green-500 to-emerald-500" },
  { icon: Shield, label: "Security", color: "from-orange-500 to-amber-500" },
  { icon: Globe, label: "Domains", color: "from-purple-500 to-pink-500" },
];
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {stats.map((stat, index) => (
            <Card
              key={stat.title}
              className={`relative overflow-hidden hover-lift ${isLoaded ? "animate-fade-in-up" : "opacity-0"}`}
